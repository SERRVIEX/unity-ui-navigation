namespace UnityEngine.UI
{
    ...
    public static class RectTransformExtensions
    {
        ...
        public static RectOffset GetMargins(this RectTransform rectTransform, RectTransform parent)
        {
            Vector2 minAnchoredPosition = rectTransform.anchoredPosition - rectTransform.sizeDelta * 0.5f;
            Vector2 maxAnchoredPosition = rectTransform.anchoredPosition + rectTransform.sizeDelta * 0.5f;

            Vector2 minParentPosition = parent.rect.min;
            Vector2 maxParentPosition = parent.rect.max;

            float left = minAnchoredPosition.x - minParentPosition.x;
            float right = maxParentPosition.x - maxAnchoredPosition.x;
            float bottom = minAnchoredPosition.y - minParentPosition.y;
            float top = maxParentPosition.y - maxAnchoredPosition.y;
        ...
        public static void SetAnchoredPositionX(this RectTransform source, float value)
        {
        ...
        public static void SetAnchoredPositionY(this RectTransform source, float value)
        {
            var anchoredPosition = source.anchoredPosition;
